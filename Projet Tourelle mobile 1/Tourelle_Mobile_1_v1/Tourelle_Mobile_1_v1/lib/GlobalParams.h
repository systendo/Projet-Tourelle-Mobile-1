...
#define PORT_0_GLOBAL_SELECT   0xe1    //Port 0 global select register (PRT0GS)
#define PORT_0_DRIVE_0         0xc1    //Port 0 drive mode 0 register (PRT0DM0)
#define PORT_0_DRIVE_1         0x3e    //Port 0 drive mode 1 register (PRT0DM1)
#define PORT_0_DRIVE_2         0x1e    //Port 0 drive mode 1 register (PRT0DM2)
...
#define PORT_1_GLOBAL_SELECT   0xe3    //Port 1 global select register (PRT1GS)
#define PORT_1_DRIVE_0         0xc7    //Port 1 drive mode 0 register (PRT1DM0)
#define PORT_1_DRIVE_1         0x38    //Port 1 drive mode 1 register (PRT1DM1)
#define PORT_1_DRIVE_2         0x18    //Port 1 drive mode 2 register (PRT1DM2)
