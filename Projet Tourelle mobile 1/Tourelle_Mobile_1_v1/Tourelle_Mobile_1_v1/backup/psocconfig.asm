...
export LoadConfig_spim_cam
export _LoadConfig_spim_cam
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_spim_cam
	lcall	LoadConfigTBL_spim_cam_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration spim_cam
;
;    Load configuration registers for spim_cam.
...
_LoadConfig_spim_cam:
 LoadConfig_spim_cam:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_spim_cam_Bank0
    mov     X, <LoadConfigTBL_spim_cam_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_spim_cam_Bank1
    mov     X, <LoadConfigTBL_spim_cam_Bank1
